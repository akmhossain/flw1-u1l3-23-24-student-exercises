...
zooSummary = creatureName + " is a creature with" + creatureDescription + ". It is " + isFriendly + " that it is friendly to humans. It is " + canVisit + " that it can be seen by visitors of " + visitorAge + " years old.";
